...
plot_21679180 <- ggplot() +
  ...
  annotate("text", x = as.Date("2024-08-21"), y = 25, label = "Zone of Physiological Stress", size = 5, color ="red", fontface = "italic") +
  scale_colour_manual("", 
...
```{r LowerCanton - Stats}
# Logger ID: 21679176 (WSC logger data)

# Read in 2024 WSC data and filter for summer season
LowerCanton <- daily_water_master %>% 
  filter(logger_id == 21679176 & longdate > '2024-06-19' & longdate <= '2024-09-15')

# 2024 Max Temp
LowerCanton_maxt <- max(LowerCanton$max_temp) 
print(paste("Max Temp C (2024):", LowerCanton_maxt))

# 2024 # Days above 20C
LowerCanton_Days20 <- sum(LowerCanton$max_temp > 20)
print(paste("# Days above 20C (2024):", LowerCanton_Days20))

```
```{r LowerCanton - Temp Plots}
...
# Export plot to file 
 ggsave(plot_21679176, file="Figure Plots/Temp Plots/Temp Plot_LowerCanton.png", height = 5, width = 8) #Figure Dimensions 4" x 6"


```

```{r LowerCanton - Regression Plots & Future Climate Scenario}
...
# Export plot to file
 ggsave(reg_plot_21679176, file="Figure Plots/Regression Plots/regression_plot_LowerCanton.png", height = 4, width = 6)
